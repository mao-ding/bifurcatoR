#!/bin/bash
#SBATCH --job-name=module2_norm_weib_Distribution_mixR
...
singularity run -B "/scratch:/scratch,/work:/work" /shared/container_repository/rstudio/rocker-geospatial-4.2.1.sif Rscript Module2_Norm_Weib_Distribution_mixR.R $SLURM_ARRAY_TASK_ID